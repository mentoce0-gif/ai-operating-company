...
Notionの「商品ポートフォリオ」「実行タスク」を運営上の正本として扱います。公開ページには商品名と第一タスクの安全な要約だけを静的スナップショットとして反映し、内部URL、阻害要因、後続タスクの詳細はPrivateなNotionに保持します。

現在の第一商品は「1業務7日ラボ」、第一タスクは監督担当の「STORES出店設定・商品URL発行」です。完了後、AI COO担当の購入導線接続へ進みます。
